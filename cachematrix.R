#makeCacheMatrix and cacheSolve functions calculate the inverse of Matrix.
...
#makeCacheMatrix function creates a special type of list with four functions:
...
#cacheSolve function calculates the inverse of a Matrix. If the inverse Matrix has
